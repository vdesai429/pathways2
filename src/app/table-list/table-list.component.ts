...
catbackup = ['General', 'Professionalism', 'Contrast Administration', 'Results Communication']
  ...
  ngOnInit() {
    this.kinvey.getCategories('policies');
...
delete() {
  ...
  this.kinvey.delete(this.deleteElement, 'policies');
}
...
testadd() {
  const add = '<img src=\'https://via.placeholder.com/150\'>'
  this.editorContent = this.editorContent + add;
}
